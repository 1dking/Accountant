    ...
    <div className="flex flex-col items-center min-h-full px-4 py-6">
      ...
      {state === 'idle' && (
        <div className="w-full max-w-md flex flex-col items-center gap-4 mt-8">
          ...
          <button
            ...
            className="w-full max-w-xs aspect-square rounded-2xl border-2 border-dashed border-blue-300 bg-blue-50/50 flex flex-col items-center justify-center gap-4 hover:bg-blue-50 active:bg-blue-100 dark:bg-blue-900/50 transition-colors"
          >
      ...
      {state === 'processing' && (
        <div className="w-full max-w-md flex flex-col items-center gap-6 mt-12">
          ...
          {previewUrl && (
            <div className="w-32 h-32 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 opacity-60">
