  ...
  return (
    <div className="p-6 max-w-2xl">
      ...
      >
        ...
        <span className="text-sm">{t('ui:NewEstimatePage.backToEstimates')}</span>
      </button>

      <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">{t('ui:NewEstimatePage.newEstimate')}</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-5 space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
             {t('ui:NewEstimatePage.client')} <span className="text-red-500">*</span>
            </label>
            <ContactSelector
              value={contactId}
              onChange={(id) => setContactId(id)}
              placeholder={t('ui:NewEstimatePage.selectAClient')}
              filterType="client"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
               {t('ui:NewEstimatePage.issueDate')} <span className="text-red-500">*</span>
              </label>
              <input
                type="date"
                required
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
               {t('ui:NewEstimatePage.expiryDate')} <span className="text-red-500">*</span>
              </label>
              <input
                type="date"
                required
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
               {t('ui:NewEstimatePage.globalTaxRate')}
              </label>
              <input
                type="number"
                step="0.01"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
               {t('ui:NewEstimatePage.discountAmount')}
              </label>
              <input
                type="number"
                step="0.01"
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t('ui:NewEstimatePage.lineItems')}</h2>
            <button
              type="button"
              onClick={addLineItem}
          ...
          <div className="space-y-3">
            ...
            <div className="hidden sm:grid sm:grid-cols-12 gap-2 text-xs text-gray-500 dark:text-gray-400 font-medium px-1">
              <div className="col-span-5">{t('ui:NewEstimatePage.description')}</div>
              <div className="col-span-2">{t('ui:NewEstimatePage.qty')}</div>
              <div className="col-span-2">{t('ui:NewEstimatePage.unitPrice')}</div>
              <div className="col-span-2">{t('ui:NewEstimatePage.tax')}</div>
              ...
              >
                <div className="sm:col-span-5">
                  <input
                    ...
                    placeholder={t('ui:NewEstimatePage.description')}
                  />
                </div>
                <div className="sm:col-span-2">
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                    placeholder={t('ui:NewEstimatePage.qty')}
                  />
                </div>
                <div className="sm:col-span-2">
                  <input
          ...
          <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700">
            <div className="flex flex-col items-end gap-1">
              <div className="flex justify-between w-64">
                <span className="text-sm text-gray-500 dark:text-gray-400">{t('ui:NewEstimatePage.subtotal')}</span>
              ...
              {totals.tax > 0 && (
                <div className="flex justify-between w-64">
                  <span className="text-sm text-gray-500 dark:text-gray-400">{t('ui:NewEstimatePage.tax_2')}</span>
                  <span className="text-sm text-gray-900 dark:text-gray-100">
              ...
              {totals.discount > 0 && (
                <div className="flex justify-between w-64">
                  <span className="text-sm text-gray-500 dark:text-gray-400">{t('ui:NewEstimatePage.discount')}</span>
              ...
              <div className="flex justify-between w-64 pt-2 border-t border-gray-200 dark:border-gray-700 mt-1">
                <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{t('ui:NewEstimatePage.total')}</span>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-5 space-y-4">
          <div>
            ...
            <textarea
              ...
              placeholder={t('ui:NewEstimatePage.anyAdditionalNotesForThe')}
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {createMutation.isPending ? t('ui:NewEstimatePage.creating') : t('ui:NewEstimatePage.createEstimate')}
          </button>
          <button
            type="button"
            onClick={() => navigate('/estimates')}
          ...
          >
           {t('ui:NewEstimatePage.cancel')}
          </button>
        </div>

        {createMutation.isError && (
          <p className="text-sm text-red-500">
           {t('ui:NewEstimatePage.failedToCreateEstimatePlease')}
          </p>
        )}
      </form>
    </div>
