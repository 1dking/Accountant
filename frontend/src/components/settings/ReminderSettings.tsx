  ...
  return (
    <div className="space-y-4">
        ...
        <form onSubmit={handleSubmit} className="bg-white border rounded-lg p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <p className="text-xs text-gray-500 mt-1">{formatOffset(form.days_offset)}</p>
            </div>
            <div>
          ...
          {(form.channel === 'email' || form.channel === 'both') && (
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-gray-600">Email Template (optional - defaults will be used if empty)</h4>
              <div>
              ...
              <div>
                <label className="block text-sm text-gray-600 mb-1">Body (HTML)</label>
                <textarea
          ...
          {(form.channel === 'sms' || form.channel === 'both') && (
            <div className="space-y-3">
              <h4 className="text-sm font-medium text-gray-600">SMS Template (optional - defaults will be used if empty)</h4>
              <div>
                <label className="block text-sm text-gray-600 mb-1">SMS Body</label>
                <textarea
                  value={form.sms_body}
      ...
      <div className="bg-gray-50 border rounded-lg p-4 text-sm text-gray-600">
        <h4 className="font-medium text-gray-700 mb-1">Template Variables</h4>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b bg-gray-50">
                ...
                <th className="text-left px-4 py-2 text-gray-500 font-medium">Timing</th>
                <th className="text-left px-4 py-2 text-gray-500 font-medium">Channel</th>
            ...
            <tbody>
              {rules.map((rule) => (
                <tr key={rule.id} className="border-b last:border-0">
                  ...
                  <td className="px-4 py-3 text-gray-600">{formatOffset(rule.days_offset)}</td>
                  <td className="px-4 py-3">
                    <span
      ...
      {/* Info section */}
      <div className="bg-gray-50 border rounded-lg p-4 text-sm text-gray-600">
        <h4 className="font-medium text-gray-700 mb-1">How Payment Reminders Work</h4>
